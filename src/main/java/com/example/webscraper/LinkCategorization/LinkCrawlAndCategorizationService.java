...
@Service
public class LinkCrawlAndCategorizationService {
    ...
    public CategorizedLinkDto categorizedLinkDto(Document document){
        ...
        return new CategorizedLinkDto(
                navigationLinks, footersLinks, sidebarsLinks, breadcrumbLinks,
                outboundLinks, backLinks, affiliateLinks, socialMediaLinks
        );
    }

    public void detectBrokenAndDuplicateLinks(String scanId, String channelId, CategorizedLinkDto categorizedLinks) {
